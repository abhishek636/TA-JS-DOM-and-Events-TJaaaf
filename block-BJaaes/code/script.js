...
let usernameError, nameError, emailError, phoneError, confirmError = "";
...
function handleSubmit(event) {
    ...
    let usernameElm = elements.username;
    let nameElm = elements.name;
    let emailElm = elements.email;
    let phoneElm = elements.phone;
    let passwordElm = elements.password;
    let confirmElm = elements.confirmPsd;
